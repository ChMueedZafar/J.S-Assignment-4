...
console.log(str.indexOf("lmno"));
console.log(str.lastIndexOf("lmno"));
...
console.log(a = d.getDate());
console.log(a = d.getDay());
console.log(a = d.getFullYear());
console.log(a = d.getHours());
console.log(a = d.getMilliseconds());
console.log(a = d.getMinutes());
console.log(a = d.getMonth());
